...
const baseUrl = 'api/wx/user/wxc881e493f40bedca/'
const baseUserUrl = 'api/community/users/'
...
export default class UserService extends BaseService {
  ...
  async bindInfo({ nickName, avatarUrl, gender, province, city }) {
    ...
    const res = await this.request(baseUserUrl + 'binding', { id: id, nick: nickName, avtater: avatarUrl, gender, province, city }, 'POST')
    if (res.code === 0) {
  ...
  async send() {
    await this.request(baseUserUrl + 'send', null, 'GET')
  }
}
