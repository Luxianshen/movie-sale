...
export const baseImgUrl = 'https://share-info-1253382295.cos.ap-guangzhou.myqcloud.com/'
// export const baseUrl = 'http://127.0.0.1:7001' + prefix
export const qiniuUrl = '' // 七牛存储自定义图片域名根据自己的配置
...
export default class BaseService {
  ...
  parseTopic(topic) {
    if (topic.iconSrc) {
      topic.iconSrc = imgUrl + topic.iconSrc
    }
    return topic
  }
