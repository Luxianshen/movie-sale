...
export default class Seat extends Component {
 ...
 render(){
   ...
   <MovableArea scale-area="true" class="defaultArea" style="height:{{seatArea}}px; width: 750rpx;">
     <MovableView class='movableOne' bindscale="handleScale" style="height:{{seatArea}}px; width: 750rpx;" scale="true" direction="all" scale-max="2" scale-min="1" out-of-bounds="true">
   ...
   <View class='selectSeatInfo' hidden='{{hidden}}'>
     <ScrollView class="scrollSeat" scroll-x style="width: 100%">
